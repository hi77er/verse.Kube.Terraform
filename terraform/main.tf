...
module "eks" {
  ...
  # Security Best Practice suggests that we have only those ports open taht we will need.
  # For the demo purpose here we have opened all ports so Consul can operate freely
